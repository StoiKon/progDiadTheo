        ...
        <div id="content">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <button type="button" id="sidebarCollapse" class="row btn btn-info">
                    ...
                    <form >
                    <button type="button" id="show" class="btn btn-info mt-2 mx-3" >Προσθήκη Μαθήματος</button>
                    </form>
                    </div>
                    <?php
                    if(isset($_POST['b'])){
                        ...
                        if(isset($_POST['title']) && !empty($_POST['title'])){
                            if(isset($_POST['semester']) && !empty($_POST['semester'])){
                                if(isset($_POST['description']) && !empty($_POST['description'])){
                                    ...
                                    addLesson($con,$semester,$descrition,$title);
                                    ?><p class="alert alert-primary"><?php print("lesson added succesfully");?></p><?php 
                    ...
                    ?>
                    <div id="addL" style="width:60vw;max-width:600px" class="hidden h-25 p-3 mt-5 mx-auto px-auto">
                ...
                <label>Εξάμηνο</label>  
                <select  id="semester" name="semester" class="form-control form-control-md">
                    ...
                    <button type="submit" name="badd" id="addLessonsForm" class="btn btn-info mt-2 mx-3" >Προσθήκη</button>
                </form>
                    </div>
                    </div>
