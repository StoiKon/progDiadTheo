        ...
        <div id="content">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div>
                    ...
                    print( "<h>χρήστης ".$_SESSION['name'] ." ρόλος ". $_SESSION['role']." AM ".$_SESSION['stAm']."</h><br>" );
                    ?>
                    </div>
                <div style="width:60vw;max-width:400px" class="mx-auto px-auto row">
                    <h style="font-weight:bold;">Τρέχουσα δήλωση</h>
                    <?php
                        $result=getStatementLessons($con,$_SESSION['stAm']);
                        ?><table class="table">
                            <thead><tr>
                    ...
                    <div id="addL" style="width:60vw;max-width:400px" class="mt-5 mx-auto px-auto ">
                    <h style="font-weight:bold;">Καινούργια δήλωση</h>
